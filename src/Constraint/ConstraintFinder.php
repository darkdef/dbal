 ...
 */
abstract class ConstraintFinder implements ConstraintFinderInterface
{
    /**
    ...
    {
        return $this->getTableMetadata($name, ConstraintInterface::PRIMARY_KEY, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::PRIMARY_KEY, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::FOREIGN_KEYS, $refresh);
    }
    ...
    {
        return $this->getTableMetadata($name, ConstraintInterface::INDEXES, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::INDEXES, $refresh);
    }
    ...
    {
        return $this->getTableMetadata($name, ConstraintInterface::UNIQUES, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::UNIQUES, $refresh);
    }
    ...
    {
        return $this->getTableMetadata($name, ConstraintInterface::CHECKS, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::CHECKS, $refresh);
    }
    ...
    {
        return $this->getTableMetadata($name, ConstraintInterface::DEFAULT_VALUES, $refresh);
    }
    ...
    {
        return $this->getSchemaMetadata($schema, ConstraintInterface::DEFAULT_VALUES, $refresh);
    }
}
